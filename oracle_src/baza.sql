...
CREATE TABLE Rezerwacje (
  ...
  numer CHAR(3) REFERENCES Pokoje NOT NULL ON DELETE CASCADE,
  id_goscia INTEGER REFERENCES Goscie NOT NULL ON DELETE CASCADE,
  id_obslugi INTEGER REFERENCES Obsluga NOT NULL ON DELETE CASCADE,
