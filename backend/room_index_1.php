    ...
    <body>
        ...
        <div class="wrap">
            ...
            <div id = "TRESC">
                ...
                <br />
                <br />
                <h2 class="underline extraBottomMargin">Usuń pokoj</h2>
                Numer pokoju:<input name="id" type="text" />
                <br />
                <h2 class="underline extraBottomMargin">Pokaż wszystkie</h2>
                <a href="show_workers.php" class="button gradient_silver">Pokaż</a>
            </div>
        </div>
    </body>
</html>
