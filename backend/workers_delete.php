        ...
        <tbody>
            ...
            while ($rekord = oci_fetch_array($wyrazenie, OCI_ASSOC)) {
                echo "<tr>
                        ...
                        <td>" . $rekord['LOGIN'] . "</td>
                        <td>" . $rekord['PENSJA'] . "</td>
<td><a href=\"workers_delete_form.php?id=" . $rekord["ID"] . "\" class=\"button gradient_silver\">Usuń</a></td></tr>";
                $from++;
            }
...
<body>
    ...
    <div class="wrap">
        ...
        <div id = "TRESC">
            <h1 class="underline extraBottomMargin">Wybierz pracownika do usunięcia (<?php echo(date("d-m-Y | G:i:s", time())); ?>)</h1>
            <?php showRooms(); ?>
        </div>
    </div>
</body>
