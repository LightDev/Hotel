        ...
        <tbody>
            ...
            while ($rekord = oci_fetch_array($wyrazenie, OCI_ASSOC)) {
                echo "<tr>
                        ...
                        <td>" . $rekord['CENA'] . "</td>
<td><a href=\"modify_reservation_form.php?id=" . $rekord["NUMER"] . "\" class=\"button gradient_silver\">Modyfikuj</a></td></tr>";
                $from++;
            }
...
<body>
    ...
    <div class="wrap">
        ...
        <div id = "TRESC">
            <h1 class="underline extraBottomMargin">Wybierz pokój do modyfikacji (<?php echo(date("d-m-Y | G:i:s", time())); ?>)</h1>
            <?php showRooms(); ?>
        </div>
    </div>
</body>
